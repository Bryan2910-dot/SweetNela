...
namespace SweetNela.Controllers
{
    ...
    public class ProductoAdminController : Controller
    {
        ...
        public ProductoAdminController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: ProductoAdmin/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProductoAdmin/Create
