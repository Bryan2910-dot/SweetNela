...
namespace SweetNela.MLintegration
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\USUARIO\Downloads\ProyectoEspVero\SweetNela\MLExcel";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"productId",inputColumnName:@"productId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Label",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"productId",ApproximationRank=17,LearningRate=0.24064558890555368,NumberOfIterations=253,Quiet=true}))      
